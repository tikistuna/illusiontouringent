...
class TicketSeller extends Model
{
	...
	public function google_maps($city){
		...
		return $this->base_url . "key=" . env('GOOGLE_MAPS_API_KEY', 'default') . "&q=" . $venue . "," . $city_name . "+" . $city->state . "&attribution_source=https://illusiontouringent.com&attribution_ios_deep_link_id=comgooglemaps://?daddr=" . $address;
	}
